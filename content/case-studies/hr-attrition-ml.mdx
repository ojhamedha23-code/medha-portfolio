...
summary: "ML pipeline to predict employee attrition on the IBM HR dataset — AUC 0.86 using LightGBM with behavioural feature engineering."
date: "2026-03-01"
...
At scale, identifying even a fraction of at-risk employees early enough for retention interventions (pay adjustments, role changes, manager conversations) translates to significant savings. Recruitment, onboarding, and lost productivity typically cost 1.5–2× an employee's annual salary per departure — early prediction compresses that cost.
